...
**Notes:**
1. The example CloudFormation template is restricted to `us-east-2` because the AMI IDs for each distro are hard-coded. To change regions, look alternate AMI IDs and change them as needed in the CloudFormation template.
