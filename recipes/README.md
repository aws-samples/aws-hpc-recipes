...
Here are example URLs for the CloudFormation template from the "getting_started" PCS recipe (**recipes/pcs/getting_started**):
* **HTTPS Template**: https://aws-hpc-recipes.s3.us-east-1.amazonaws.com/main/recipes/pcs/getting_started/assets/cluster.yaml
* **S3 Template**: s3://aws-hpc-recipes/main/recipes/pcs/getting_started/assets/cluster.yaml
