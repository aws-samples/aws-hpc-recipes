...
try {
    ...
    Add-ADGroupMember -Identity "CN=$computer_write_group,$users_ou" -Members "$service_account_name"
    ...
    Set-Acl -AclObject $acl -Path "AD:$computers_ou"
    echo "Success."
}
catch {
