...
- **[AGENTS.md](AGENTS.md)** - The development contract for this repository, following the [AGENTS.md format](https://agents.md/): repository layout, conventions, the invariants CI enforces, and how to validate your work.

## Contributing

We encourage your contributions to this collection. Read our [contribution process and guidelines](CONTRIBUTING.md) and the [AGENTS.md](AGENTS.md) development contract, then head to **[Get Started](docs/start.md)** to begin. 
